...
import { accreditationsApi, type AccreditationProfile, type BackgroundStatus, type ItemDecision, type ReviewStatus } from '../../../lib/api'
import { Field, Fields, Panel, PanelSection, StatusBadge, dateTime, day, useAdmin, yesNo } from '../ui'
...
import { EXPIRED_RED, ExpiryValue, vehicleLine, withAge } from './shared'
...
export function ProfileSections({ profile, version, onReviewed }: {
  profile: AccreditationProfile
  version: number
  onReviewed: () => void
}) {
